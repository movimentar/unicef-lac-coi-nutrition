...
Nutrition in Emergencies is not an optional add-on but a core component of humanitarian response. The findings demonstrate that underinvestment results in preventable mortality, lost years of healthy life, and diminished human capital with long-term economic costs. By applying a Cost of Inaction framework, we show that scaling NiE coverage could yield outsized health and economic returns, particularly in displacement-affected settings.
